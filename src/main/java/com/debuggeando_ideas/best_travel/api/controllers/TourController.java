...
public class TourController {
    ...
    @Operation(summary = "Save in system one tour based in hotel and fly list")
    @PostMapping
    ...
    @Operation(summary = "Return one tour with passed Id")
    @GetMapping(path = "{id}")
    public ResponseEntity<TourResponse> get(@PathVariable Long id){
        return ResponseEntity.ok(this.tourService.read(id));
    }
    @Operation(summary = "Delete one tour with id passed")
    @DeleteMapping(path = "{id}")
    public ResponseEntity<Void> delete(@PathVariable Long id){
        this.tourService.delete(id);
        return ResponseEntity.noContent().build();
    }
    @Operation(summary = "Remove one ticket from tour")
    ...
    @Operation(summary = "Add one fly from tour")
    ...
    @Operation(summary = "Remove one reservation from tour")
    ...
    @Operation(summary = "Add one reservation from tour")
